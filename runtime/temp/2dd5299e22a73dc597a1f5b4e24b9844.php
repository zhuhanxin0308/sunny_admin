<?php /*a:1:{s:72:"E:\web\Apache24\htdocs\new\admin\application\index\view\index\index.html";i:1536335269;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body class="lay-blog">
		<div class="header">
			<div class="header-wrap">
				...
				<form class="layui-form blog-seach pull-left" action="/index/index/search">
				...
				<div class="blog-nav pull-right">
					<ul class="layui-nav pull-left">
					  <li class="layui-nav-item layui-this"><a href="/index/index/index.html">首页</a></li>
					<!--   <li class="layui-nav-item"><a href="message.html">留言</a></li>
					  <li class="layui-nav-item"><a href="about.html">关于</a></li> -->
					</ul>
					<a href="/web/start" class="personal pull-left">
			      ...
			      $.get('/index/index/list?page='+page, function(res){
			       ...
			       //  	})
			          lis.push(`<div class="item" style="max-height: 400px;overflow: hidden;">
							<div class="item-box  layer-photos-demo1 layer-photos-demo">
								<h3>
									<a style="display: -webkit-box;max-height: 30.67px;-webkit-line-clamp: 1;-webkit-box-orient: vertical;overflow: hidden;" href="/index/index/details.html?id=${item.id}">${item.title}
									</a>
								</h3>
							...
							<div class="comment count">
								<a href="/index/index/details.html?id=${item.id}">评论</a>
